		...
		<div class="col-md-9">	
			<form class="form-horizontal" name=post method=post action="PostProc.jsp">
				...
				<div class="form-group">
					<label for="b_subject" class="col-sm-2 control-label">제목</label>
					<div class="col-sm-8">
						<input type="text" class="form-control" name="b_subject" placeholder="제목을 입력하세요">
					</div>
				</div>
				...
				<div class="form-group">
			  	...
			  	<!-- 내용 -->	
				<div class="form-group">
			    	<label for="b_content" class="col-sm-2 control-label">내용</label>
					<div class="col-sm-8">
						<textarea class="form-control" rows="10" name="b_content" placeholder="내용을 입력하세요"></textarea>
					</div>
				</div>
